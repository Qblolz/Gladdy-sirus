...
--    if ( self ) then
--        if ( TotemPulse.addon ) then
--            return TotemPulse:GetAddonFrame(self)
...
--            TotemPulse:CreateTotemFrame(nameplate)
--        end
--
...
--    end
--    if eventType == "UNIT_DIED" and self.timeStamps[destGUID] then
--        self.timeStamps[destGUID] = nil
--    end
--    if (eventType == "SWING_DAMAGE" or eventType == "SPELL_DAMAGE") and self.timeStamps[destGUID] then
--        self.timeStamps[destGUID] = nil
--    end
--    if not pulse then
--        return
...
--        if not self:IsArenaUnit(sourceName) then
--            return
--        end
--
--        if not Gladdy.dbi.profile.totemPulseTotems["totem" .. cooldowns[spellID].id].enabled then
--            return
--        end
--        if self.timeStamps[sourceGUID] then
--            self.timeStamps[destGUID] = self.timeStamps[sourceGUID]
--            self.timeStamps[destGUID].id = cooldowns[spellID].id
--            self.timeStamps[sourceGUID] = nil
--        else
--            self.timeStamps[destGUID] = { timeStamp = GetTime(), pulse = pulse, id = cooldowns[spellID].id }
--        end
--    end
--end
--
--function TotemPulse:NAME_PLATE_UNIT_REMOVED(nameplate)
...
--end
--
--function TotemPulse:NAME_PLATE_UNIT_ADDED(nameplate)
--    self:OnUnitAdded(nameplate, "NAME_PLATE_UNIT_ADDED")
--end
--
--function TotemPulse:UNIT_NAME_UPDATE(nameplate)
--    self:OnUnitAdded(nameplate, "UNIT_NAME_UPDATE")
--end
--
--function TotemPulse:OnUnitAdded(nameplate, unitId)
--    local isEnemy = UnitIsEnemy("player", unitId)
--    local guid = nameplate.guid
--
...
-----------------------------------------------------
--
--function TotemPulse:CreateCooldownFrame(nameplate, style)
--    local totemTick
--
...
--
--    -- Hooks
--    nameplate:HookScript("OnHide", TotemPulse.NAME_PLATE_UNIT_REMOVED)
--    nameplate:HookScript("OnShow", TotemPulse.NAME_PLATE_UNIT_ADDED)
--
--    return totemTick
--end
--
...
--            nameplate.totemTick = TotemPulse:CreateCooldownFrame(nameplate, Gladdy.db.totemPulseTotems["totem" .. timestamp.id].style)
--        end
...
--        self:SetScript("OnEvent", TotemPulse.OnEvent)
--    else
...
--end
--
--function TotemPulse:IsArenaUnit(name)
--    for i=1, 5 do
