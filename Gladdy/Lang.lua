...
-- Classes
L["Druid"] = C_CreatureInfo._GetClassInfo(11).className
L["Deathknight"] = C_CreatureInfo._GetClassInfo(6) and C_CreatureInfo._GetClassInfo(6).className
L["Hunter"] = C_CreatureInfo._GetClassInfo(3).className
L["Mage"] = C_CreatureInfo._GetClassInfo(8).className
L["Paladin"] = C_CreatureInfo._GetClassInfo(2).className
L["Priest"] = C_CreatureInfo._GetClassInfo(5).className
L["Rogue"] = C_CreatureInfo._GetClassInfo(4).className
L["Shaman"] = C_CreatureInfo._GetClassInfo(7).className
L["Warlock"] = C_CreatureInfo._GetClassInfo(9).className
L["Warrior"] = C_CreatureInfo._GetClassInfo(1).className

-- Races
L["Human"] = C_CreatureInfo._GetRaceInfo(1).raceName
L["Orc"] = C_CreatureInfo._GetRaceInfo(2).raceName
L["Dwarf"] = C_CreatureInfo._GetRaceInfo(3).raceName
L["Night Elf"] = C_CreatureInfo._GetRaceInfo(4).raceName
L["Undead"] = C_CreatureInfo._GetRaceInfo(5).raceName
L["Tauren"] = C_CreatureInfo._GetRaceInfo(6).raceName
L["Gnome"] = C_CreatureInfo._GetRaceInfo(7).raceName
L["Troll"] = C_CreatureInfo._GetRaceInfo(8).raceName
L["Blood Elf"] = C_CreatureInfo._GetRaceInfo(10).raceName
L["Draenei"] = C_CreatureInfo._GetRaceInfo(11).raceName
